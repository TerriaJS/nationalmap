...
if (argv.help) {
    ...
    if (cluster.isMaster) {
        ...
        cluster.on('exit', function(worker) {
            ...
            console.log('Worker ' + worker.id + ' died :D');
            cluster.fork();
        ...
        app.post('/convert', function(req, res, next) {
            ...
            form.parse(req, function(err, fields, files) {
                ...
                var ogr = ogr2ogr(inputStream, hint).skipfailures().options(['-t_srs',
                                                                             'EPSG:4326']);
        ...
        app.post('/nm_service_1', function(req, res, next) {
            ...
            form.parse(req, function(err, fields, files) {
                ...
                res.json({
                    displayHtml: 'Here are the available bike racks.',
                    layer: obj
                });
            });
        });
